...
public class Users extends Project
{
	Kiosk ks;
	...
	public void join()
	{
    	...
    	System.out.print("전화번호('-'을 포함해서 입력): ");
    	member.setPwd(sc.nextLine());
    	System.out.print("주민등록번호('-'포함) ▶ ");
    	member.setSsn(sc.nextLine());
...
/*
		...
		MData.memList.put(keyofUser, new Members(nameofUser));
